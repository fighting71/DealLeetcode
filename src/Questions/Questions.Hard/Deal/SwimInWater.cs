...
namespace Questions.Hard.Deal
{
    ...
    /// @des : 
    /// 
    ///     在N x N网格上，每个方格网格[i][j]表示点(i,j)处的高程。
    ///     现在开始下雨了。在时刻t，所有地方的水的深度都是t。当且仅当两个正方形各自的高程都不超过t时，你可以从一个正方形游到另一个四个方向相邻的正方形。你可以在零时间内游无限长的距离。当然，在游泳过程中，您必须保持在网格的边界内。
    ///     你从左上角的正方形(0,0)开始，最少需要多少时间才能到达右下角的正方形(N-1, N-1)?
    /// 
    /// </summary>
